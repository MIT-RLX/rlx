...
pub fn quantize(src: &[f32], dtype: GgmlType) -> Result<Vec<u8>> {
    match dtype {
        ...
        GgmlType::IQ4NL => crate::iq_quantize::quantize_iq4_nl(src),
        GgmlType::IQ4XS => crate::iq_quantize::quantize_iq4_xs(src),
        GgmlType::IQ2XXS => crate::iq_quantize::quantize_iq2_xxs(src),
        GgmlType::IQ2XS => crate::iq_quantize::quantize_iq2_xs(src),
        GgmlType::IQ2S => crate::iq_quantize::quantize_iq2_s(src),
        GgmlType::IQ3XXS => crate::iq_quantize::quantize_iq3_xxs(src),
        GgmlType::IQ3S => crate::iq_quantize::quantize_iq3_s(src),
        GgmlType::IQ1S => crate::iq_quantize::quantize_iq1_s(src),
        GgmlType::IQ1M => crate::iq_quantize::quantize_iq1_m(src),
        GgmlType::TQ1_0 => crate::tq_quantize::quantize_tq1_0(src),
        GgmlType::TQ2_0 => crate::tq_quantize::quantize_tq2_0(src),
        GgmlType::MXFP4 => crate::mx_quantize::quantize_mxfp4(src),
        GgmlType::NVFP4 => crate::mx_quantize::quantize_nvfp4(src),
