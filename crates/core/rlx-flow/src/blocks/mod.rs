...
pub use dit_modulation::{AdaLayerNormStage, GatedResidualStage, dit_ada_gated_linear};
...
pub use llama_layer::{
    llama_prefill_layer_attn_only, llama_prefill_layer_composed, llama_prefill_layer_fused,
    llama_prefill_layer_mlp_only,
};
...
pub use qwen3_layer::{
    qwen3_decode_layer_fused, qwen3_decode_layer_fused_qk, qwen3_decode_layer_fused_tap,
    qwen3_decode_layer_side, qwen3_decode_layer_side_tap, qwen3_prefill_layer_fused,
    qwen3_prefill_layer_fused_kv, qwen3_prefill_layer_fused_kv_qk, qwen3_prefill_layer_side,
};
...
pub use spd::{BiMapStage, LogEigStage, ReEigStage, SpdBatchNormStage};
