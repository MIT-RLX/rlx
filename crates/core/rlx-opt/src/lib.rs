...
pub use rlx_compile::{
    ...
    CommonSubexpressionElimination, CompilePipeline, CompileResult, ConstantFolding,
    DeadCodeElimination, DispatchPath, FusionLimits, FusionOptions, FusionTarget,
    KernelDispatchConfig, KernelDispatchPolicy, KernelDispatchReport, KindDispatchSummary,
    LegalizeBroadcast, LegalizeResult, MemoryPlanOptions, OpKind, PipelineInspect, Precision,
