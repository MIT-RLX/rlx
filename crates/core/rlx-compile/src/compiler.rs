...
use crate::fusion_target::with_fusion_context;
...
impl Default for CompilePipeline {
    fn default() -> Self {
        Self {
            ...
            lint_numerics: rlx_ir::env_registry::flag("RLX_LINT_NUMERICS"),
            fusion_report: rlx_ir::env_registry::flag("RLX_FUSION_REPORT"),
            no_io_peaks_output: rlx_ir::env_registry::flag("RLX_NO_IO_PEAKS_OUTPUT"),
        }
    }
}
