...
//! `kernels/conv_transpose2d.cu`; kept for manual debugging. Thin adapters
//! over [`rlx_gpu_host`] vision helpers.
...
pub fn run_layer_norm2d(
    ...
    rlx_gpu_host::run_layer_norm2d_nchw(
        &mut arena, src, g, b, dst, n as usize, c as usize, h as usize, w as usize, eps,
    );
}
