...
//! as Metal `gru` and wgpu `gru.wgsl`. Gate order r, z, n; separate b_ih/b_hh;
//! `linear_before_reset=1`; h0 = 0.
...
/// Launch native GRU. All `*_byte` args are byte offsets into `arena`.
