...
//
// NVIDIA / Vulkan wide-tile matmul: 64×64 output tile, 16×16 workgroup.
//
// Uses TILE_K=32 to minimize workgroup barriers on large K (1024³ → 32
// K-tiles vs 128 with TILE_K=8). Each thread owns a 4×4 output register block.
...
var<workgroup> tile_a: array<array<f32, 32>, 64>;
var<workgroup> tile_b: array<array<f32, 64>, 32>;
