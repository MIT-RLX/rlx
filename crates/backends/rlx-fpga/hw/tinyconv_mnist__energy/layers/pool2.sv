...
// ─────────────────────────────────────────────────────────────────────
// pool2_kernel — INT8 maxpool 2x2 stride 2x2 on [11x11x16] → [5x5x16]
// ─────────────────────────────────────────────────────────────────────
...
module pool2_kernel (
    ...
    output logic [8:0]              y_addr,
    output logic                       y_we,
    output logic signed [7:0]          y_din
);
    localparam int H_IN=11, W_IN=11, C=16;
    localparam int H_OUT=5, W_OUT=5;
