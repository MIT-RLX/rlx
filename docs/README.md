...
| [rlx-bake.md](rlx-bake.md) | **`rlx-bake` walkthrough** — what bake is (vs model+weights), pipeline, format / encrypt, full MNIST train→bake→encrypt→run steps and how to read the stats |
